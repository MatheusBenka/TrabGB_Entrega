/* analisa_LPD.java */
/* Generated By:JavaCC: Do not edit this line. analisa_LPD.java */
import java.io.*;
class analisa_LPD implements analisa_LPDConstants {
  ...
  static final public void Declara_Variavel() throws ParseException {int td;
        Token v1 = new Token();
        Token v2 = new Token();
        Token var = new Token();
...
td = token.kind;
  ...
  static final public void Programa_Principal() throws ParseException {tabela_simb.SetTables();
  ...
  static final public void Variaveis_Locais() throws ParseException {int td;
        Token var;
    Tipo_Dados();
td = token.kind;
    var = jj_consume_token(IDENTIFICADOR);
...
tabela_simb.InserirSimbolo(var, td);
  ...
  static final public void Variaveis_Atribuicao(Token v1) throws ParseException {Token v2;
        Token v3;
        String res;
        boolean imp = false;
...
v3 = token;
  ...
  static final public int Operacao() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case MAIS:{
...
{if ("" != null) return 0;}
  ...
  static final public void Tipo_Dados() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case INTEIRO:{
      jj_consume_token(INTEIRO);
      break;
  ...
  static final public void Atribuicao() throws ParseException {Token v1;
        Token v2;
        Token v3;
        int aux;
        String res;
...
v3 = token;
  ...
  static final public void Tipos_Atribuicao() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VERDADEIRO:{
...
if(v1.image != null){
  ...
  static private boolean jj_3R_9()
 {
  ...
  static public analisa_LPDTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x2400,0x400,0x2,0x30000,0x2,0x4000,0x2,0x3c003c,0x230200,0x30000,0x200,0x3c,0x30000,0x3c0000,0x240000,};
   }
  ...
  public analisa_LPD(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public analisa_LPD(java.io.InputStream stream, String encoding) {
    ...
    token_source = new analisa_LPDTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public analisa_LPD(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public analisa_LPD(analisa_LPDTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(analisa_LPDTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
